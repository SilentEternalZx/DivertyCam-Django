# Generated by Django 5.1.5 on 2025-06-05 14:05
...
# Generated by Django 5.1.5 on 2025-05-30 16:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "background_image",
                    models.ImageField(
                        blank=True, null=True, upload_to="collage/backgrounds/"
                    ),
                ),
                ("background_size", models.CharField(default="cover", max_length=20)),
                (
                    "background_position",
                    models.CharField(default="center", max_length=20),
                ),
                (
                    "background_repeat",
                    models.CharField(default="no-repeat", max_length=20),
                ),
                (
                    "template_data",
                    models.TextField(
                        help_text="Datos completos de la plantilla en formato JSON"
                    ),
                ),
                ("es_predeterminada", models.BooleanField(default=False)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.MinLengthValidator(
                                3, "El nombre debe ser de al menos 2 caracteres"
                            )
                        ],
                        verbose_name="Nombre",
                    ),
                ...
                (
                    "cedula",
                    models.CharField(
                        db_index=True, max_length=20, unique=True, verbose_name="Cédula"
                    ),
                ),
                (
                    "fechaNacimiento",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "direccion",
                    models.CharField(
                        max_length=255, verbose_name="Dirección del evento"
                    ),
                ),
                (
                    "fecha_creacion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mensaje_bienvenida",
                    models.CharField(
                        default="¡Bienvenidos a nuestro photobooth!", max_length=255
                    ),
                ),
                (
                    "imagen_fondo",
                    models.ImageField(
                        blank=True, null=True, upload_to="photobooth/fondos/"
                    ),
                ),
                ("color_texto", models.CharField(default="#000000", max_length=7)),
                ("tamano_texto", models.IntegerField(default=24)),
                ...
                (
                    "permitir_personalizar",
                    models.BooleanField(
                        default=True,
                        help_text="Permitir a los usuarios mover y redimensionar fotos",
                    ),
                ),
                (
                    "evento",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="config_photobooth",
                        to="usuarios.evento",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="collage_templates",
                to="usuarios.evento",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invitado",
                    models.ManyToManyField(
                        null=True, related_name="fotografias", to="usuarios.invitado"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mensaje_bienvenida",
                    models.CharField(
                        default="¡Bienvenidos al photobooth!", max_length=200
                    ),
                ),
                (
                    "imagen_fondo",
                    ...
                    models.IntegerField(
                        ...
                        validators=[
                            django.core.validators.MinValueValidator(
                                1, message="El tiempo mínimo entre fotos es 1 segundo"
                            ),
                            django.core.validators.MaxValueValidator(
                                20,
                                message="El tiempo máximo entre fotos es 20 segundos",
                            ),
                        ],
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        validators=[
                            django.core.validators.MinValueValidator(
                                1, message="La cuenta regresiva mínima es 1 segundo"
                            ),
                            django.core.validators.MaxValueValidator(
                                10, message="La cuenta regresiva máxima es 10 segundos"
                            ),
                        ],
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        validators=[
                            django.core.validators.MinValueValidator(
                                100, message="El ISO mínimo es 100"
                            ),
                            django.core.validators.MaxValueValidator(
                                3200, message="El ISO máximo es 3200"
                            ),
                        ],
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        validators=[
                            django.core.validators.MinValueValidator(
                                1, message="Debe imprimir al menos 1 copia"
                            ),
                            django.core.validators.MaxValueValidator(
                                10, message="Máximo 10 copias por impresión"
                            ),
                        ],
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        validators=[
                            django.core.validators.MinValueValidator(
                                1,
                                message="El tiempo mínimo de visualización es 1 segundo",
                            ),
                            django.core.validators.MaxValueValidator(
                                10,
                                message="El tiempo máximo de visualización es 10 segundos",
                            ),
                        ],
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="photobooth_config",
                        to="usuarios.evento",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "frame_index",
                    models.IntegerField(help_text="Índice del marco en la plantilla"),
                ),
                ("image", models.ImageField(upload_to="collage/session_photos/")),
                ("taken_at", models.DateTimeField(auto_now_add=True)),
                (
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["search_vector"], name="usuarios_cl_search__108e6a_gin"
            ),
        ),
        migrations.AddIndex(
            model_name="evento",
            index=models.Index(
                fields=["fecha_hora"], name="usuarios_ev_fecha_h_e4dd0a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="evento",
            index=models.Index(
                fields=["cliente"], name="usuarios_ev_cliente_4edfc3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="evento",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["search_vector"], name="usuarios_ev_search__de3133_gin"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="sessionphoto",
